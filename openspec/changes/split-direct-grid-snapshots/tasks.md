...
- [ ] 1.1 Freeze actual17nodeids/import+signature/callableAST/guard baselines; publish placement and pending provenance rows before source.
- [ ] 1.2 Split producer by placement, keeping concreteclass/__init__/produce/canonicalread patch sites; disjoint stateless carriers and unchanged definitions/constants.
- [ ] 1.3 Split file-store by placement, keeping concrete dataclass/fullfields/MAXread sites and oldimports; distinct UTF8serializer unchanged.
- [ ] 1.4 Extract fake/assets/builders only; retain all13seed bodies/decorators in original test entry, all17node IDs and companionimports.
- [ ] 1.5 Register every new exactheader/target, flip pending tolanded with files, update count/provenancenotes; inheritedRuff rules only exactpaths if needed, no new rules/globs.
