...
Do not broaden shared _close_acquired_file_fd globally: its consumers have separate contracts.
Alternative nested finally ownership flow is rejected because it increases transfer/retry complexity.
Sibling surfaces: three bounded readers and object-store helper consumers remain unchanged; directory walkers are explicitly excluded.
