## Implementation
- [x] 1.1 Publish exactplacement and fivependingcanonical provenance rows after frozenAST/API/collection/smoke baseline.
- [x] 1.2 Relocate canonical definitions; preserve wholeIFSclass/super and protectedreader facadeglobals, exactfuturemode andoldexports.
- [x] 1.3 Relocate yd rawcopy helpers; retain stage_rawfloor/22targets/strtether/writecleanup andoldexports; nofuture/no falsemarker.
- [x] 1.4 Flip fiveheaders/inventoryrowslanded, inherit onlyexistingcanonicalRuffrules at exactpaths; removeexacttwo sizeexclusions, tenfiles<1000.
## Verification
