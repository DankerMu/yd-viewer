# run-controller Specification

## Purpose
Define ordered forecast progression, attempt ownership, Slurm execution, checkpoint publication, failure handling and safe retention under one run lock.
## Requirements
