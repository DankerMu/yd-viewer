# yd-native-input Specification

## Purpose
Define the fixed yd native prepared-file contract and its staged assembly and checkpoint-recovery paths, preserving existing ownership, state, and publication safeguards.
## Requirements
