# checkpoint-tracker Specification

## Purpose
Define job-local T+12 checkpoint capture, verified attempt-local authority and deterministic recovery without additional Slurm submissions.
## Requirements
