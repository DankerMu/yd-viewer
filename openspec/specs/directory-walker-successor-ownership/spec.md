# directory-walker-successor-ownership Specification

## Purpose
Define directory-descriptor handoff ownership and one-attempt cleanup while preserving no-follow walking, listing semantics and original failure causality.
## Requirements
