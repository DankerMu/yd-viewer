# init-bootstrap Specification

## Purpose
Define fail-closed initialization of both source state chains in a new root using validated calibrated states and complete raw input windows.
## Requirements
### Requirement: 只在全新根执行
